...
parameters = {'chat_id': chat_ids[0], 'text': 'Assalomu alaykum bugun 5-iyul'}

# response = requests.get(base_url, data=parameters)
# print(response.text)

# # Ko'p habar bir vaqtda yuborish
# texts = ['Assalomu alaykum', 'Bugun osmon ochiq boladi', 'harorat 35 gradus issiq bolishi kutilmoqda',
